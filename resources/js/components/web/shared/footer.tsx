...
export default function Footer() {
  return (
    <footer className="relative">
        ...
        <div className="relative rounded-t-xs bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white overflow-hidden px-2 md:px-0">
            ...
            <div className="relative max-w-7xl mx-auto px-[4%] md:px-[8%] pt-20">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 mb-6">
                    ...
                    <div className="flex items-center mb-6">
                        ...
                        <div>
                        <h2 className="text-2xl font-bold text-white mb-1">Denancy Legends</h2>
                    ...
                    <div className="flex space-x-3 mb-8">
                        ...
                        {/* Facebook - Modern */}
                        <div className="w-8 h-8 bg-amber-400 rounded-xl flex items-center justify-center hover:bg-amber-400 transition-all duration-300 cursor-pointer group hover:scale-110 hover:rotate-12">
                        ...
                        {/* WhatsApp - New Icon */}
                        <div className="w-8 h-8 bg-amber-400 rounded-lg flex items-center justify-center hover:bg-amber-400 transition-all duration-300 cursor-pointer group hover:scale-110 hover:-rotate-12">
